...
(204, FALSE, 2, 'Chambre Élégance avec vue sur le jardin, idéale pour se détendre. Équipée d\'un lit king-size et d\'une salle de bain en marbre, elle offre une ambiance sereine avec un accès direct au jardin, parfait pour les amoureux de la nature.', 1, 'Minimal Business', '{"room":"/roomExcel.svg", "sdb":"/roomExcelSdb.svg", "salon":"/roomExcelSalon.svg"}'),
(205, TRUE, 1, 'Chambre Exécutive Prestige avec vue sur la mer, équipée d\'un minibar et d\'une décoration raffinée. Cette chambre offre un lit king-size, un coin salon et une salle de bain luxueuse, créant un espace idéal pour se détendre après une longue journée.', 5, 'Jardin Secret', '{"room":"/roomBusiSea.svg", "sdb":"/roomBusiSeaSdb.svg", "salon":"/roomBusiSeaSalon.svg"}'),
